...
var e1 =
  ...
  m1 = function (e) {
    ...
    return v1(e) ? t : 'object' == e1(e) ? JSON.stringify(e) : e.toString();
  },
  p1 = function (A) {
    return m1(A).trim();
  },
  ...
  l = function (e) {
    return (
      !!v1(e) || ('object' == e1(e) ? 0 == Object.keys(e).length : '' == p1(e))
    );
  },
  m = function (A) {
    return !l(A);
  ...
  z1 = function (A, e) {
    ...
    if (t) {
      for (var n = !1, i = 0; i < e.length; i++)
        if (-1 != e[i].indexOf(A) || -1 != A.indexOf(e[i])) {
          n = !0;
          break;
        }
      return n;
  ...
  z = function A() {
    ...
    t.globalData.shake &&
      -1 == e.url.indexOf('/online') &&
      -1 == e.url.indexOf('/common') &&
  ...
  T = function (A) {
    ...
    ('post' == a &&
      ...
      : ('object' == e1(i) && ((i = JSON.stringify(i)), (A.data = i)), (r = i));
    // var s = g(),
    var s = A['x-nonce'],
      u = m1(new Date().getTime()),
      c = h(n, r, u, s),
      f = A.header || {};
    (l(A.auth) || A.auth) &&
      (f = Object.assign2(f, {
  ...
  h = function (A, e, t, n) {
    ...
    r.push('timestamp=' + t), r.push('nonce=' + n), r.push('key=' + d);
    var i = r.join('&'),
      a = Z(t + '@@' + d1),
      s = Z(n + '@@' + d1),
      o = U(i);
  ...
  y1 = function (A) {
    var e = p1(A).toLowerCase();
    return (
      m(e) && !z1(e, ['null', 'undefined', '{}', '[]']) && e.length <= 2048
    );
  },
  C = function (A, e) {
    ...
    if (e.header['x-encrypt'] || !1) {
      ...
      var s = i.join(''),
        u = n.encrypt || JSON.parse(n).encrypt,
        c = I(u, s);
      try {
        n = JSON.parse(c);
      } catch (A) {
      ...
      success: function (A) {
        if (0 == A.status) {
          ...
          r.init && F(),
            ...
            (t.globalData.medicalCertUrl = r.medicalCertUrl || ''),
            (t.globalData.subscribeWeb = r.subscribeWeb || !1),
            e && e();
        } else n && n(A.message);
      },
      fail: function (A) {
...
var ALL = {
  ...
  reverse: p,
  isTrue: function (A) {
    return !v1(A) && 'true' == m1(A).toLowerCase();
  },
  isFalse: function (A) {
    return !v1(A) && 'false' == m1(A).toLowerCase();
  },
  getWeek: function (A) {
    return [
      '星期日',
